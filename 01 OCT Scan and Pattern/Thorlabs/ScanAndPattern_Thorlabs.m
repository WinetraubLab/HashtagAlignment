...
switch(config.octProbeLens)
    ...
    case '40x'
        ...
        photobleachUnderInterface_mm = +25e-3 + [0 75e-3 150e-3]; % We don't want to photobleach exactly at the gel-air interface. How much below it? (mm). 40x we photobleach in a few spots
