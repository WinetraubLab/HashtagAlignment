...
config.octProbeLensWorkingDistance = 3.5; %mm
...
scanParameters = yOCTScanTile (...
    ...
    'lensWorkingDistance', config.octProbeLensWorkingDistance, ...
...
if (config.overview.isScanEnabled)
    ...
    scanParameters = yOCTScanTile (...
        ...
        'lensWorkingDistance', config.octProbeLensWorkingDistance - ...
         abs(config.photobleach.z-z(1)), ... Subtract distance from top scan to the surface of gel
        'octProbePath', config.octProbePath, ...
        'tissueRefractiveIndex', config.tissueRefractiveIndex, ...
        'xOffset', 0, ...
        'yOffset', 0, ... 
