...
bodyFilePath = [currentFileFolder '\body.jpg']; %Source: https://www.vectorstock.com/royalty-free-vector/cartoon-color-human-body-anatomy-set-vector-27280733
...
bodyPartsNames = cellfun(@(x)(strrep(lower(x),'lower eyelid','eyelid')),bodyPartsNames,'UniformOutput',false);
