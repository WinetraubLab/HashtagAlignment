...
stackConfig.histologyInstructions.notes = [...
    ...
    '.sectionDepthsRequested_um is how deep to cut from full face (0 been the current full face). This number is before applying knife calibration. Notice that the numbers in the instructions which are sent to histology include knife calibration.' newline ...
