...
classdef Manager_Tile   
    ...
    methods(Access = 'public')
        ...
        % Description:
        %   Caches the given image so that it can be previewed or
        %   pre-processed before being added to the composite image.
        %
        % Parameters:
        ...
        %               the overlayed image.
        %
        function preview = previewImage(obj, drawColor, varargin)
