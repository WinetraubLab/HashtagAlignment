%
% File: Manager_Camera_Thorlabs.m
% -------------------
% Author: Erick Blankenberg
% Date 8/1/2018
% 
% Description:
%   This class acts as an interface for one Thorcam camera. This
%   class uses the framework associated with the Thorlabs Thorcam
%   SDK, which seems to introduce artifacts.
%

classdef Manager_Camera_Thorlabs
    ...
    methods(Access = 'public')
        ...
        %
        function obj = Manager_Camera_Thorlabs(cameraID)
